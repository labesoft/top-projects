...
from alarm.model import A_TIME, Alarm, ZERO
...
class AlarmController:
    ...
    def preset_alarm_time(self):
        ...
        :return: None
        """
        a_time = A_TIME(hour=self.alarm_view.hour_var.post(),
                        min=self.alarm_view.min_var.post(),
                        sec=self.alarm_view.sec_var.post())
