...
class Greeter:
    ...
    def in_new_letter(self):
        ...
        """
        return self.input(i18n.IN_MSG_LETTER).strip()
    ...
    def out_end_game(self, hanged_image, end_msg, word):
        ...
        self._out(end_msg)
        self._out(i18n.OUT_MSG_ANSWER.format(word))
    ...
    def out_farewell(self):
        ...
        self._out(i18n.OUT_MSG_THANKS)
        self._out(i18n.OUT_MSG_GOODBYE.format(self.player_name))

    def out_invalid_letter(self):
        """Informs the player that his choice is invalid"""
        self._out(i18n.OUT_MSG_INVALID)
    ...
    def out_init_attempt(self, hangman, attempt_nb, word):
        ...
        """
        self._out(hangman)
        self._out(i18n.OUT_MSG_NB_ATTEMPT.format(attempt_nb))
        self._out(SPACE_STR.join(list(word)))
    ...
    def out_in_welcome(self, hangman):
        ...
        """
        self._out(i18n.OUT_MSG_WELCOME)
        self._out(hangman)
        self.player_name = self.input(i18n.IN_MSG_NAME)
        self._out(i18n.OUT_MSG_LUCK.format(self.player_name))
        self._out(FORMAT_NEWLINE_PRE(i18n.OUT_MSG_READY))
