...
class TestConsole(TestCase):
    ...
    def setUp(self, w, h) -> None:
        self.console = Console(word=w, hangman=h, c_out=MagicMock(), c_in=MagicMock())
    ...
    def test_play_again_wrong_yes(self):
        ...
        self.console.input = MagicMock(side_effect=['WRONG', choice, StopIteration])
    ...
    def test_out_farewell(self):
        ...
        # Evaluate test
        calls = [call(i18n.OUT_MSG_THANKS), call(i18n.OUT_MSG_GOODBYE.format(self.name))]
    ...
    def test_out_end_turn(self):
        ...
        # Evaluate test
        self.console.c_out.assert_called_once_with(FORMAT_NEWLINE_PRE(self.message))
    ...
    def test_out_init_attempt(self):
        ...
        # Evaluate test
        calls = [call(str(self.console.hangman)), call(i18n.OUT_MSG_NB_ATTEMPT.format(self.console.hangman.attempt)),
                 call('')]
        self.console.c_out.assert_has_calls(calls)
